...
def parse_hparams(setups={}, Tokenizer=None):
    ...
    if Tokenizer is not None:
        ...
        if len(hparams.additional_tokens) > 0:
            ...
            special_tokens_dict = {'additional_special_tokens':hparams.additional_tokens} #codeT5 add_special_tokens
            hparams.tokenizer.add_special_tokens(special_tokens_dict)
